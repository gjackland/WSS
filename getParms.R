...
#Add in ONSdata by hand.  this provides a check on the Case-based R and rescales the cases as testing winds slowly down
  ...
  eng_prev<-c(
    ...
    2.92,2.43,1.73,1.48,1.60,1.73,2.01,2.20,4.53,4.02,2.61,1.62,1.42,1.56,1.88,2.18)*engpop/100
  ...
  scot_prev<-c(0.05,0.05,0.05,0.07,0.11,0.19, 0.21, 0.41,0.62,0.57,0.71,0.90,0.75,
               ...
               2.22,2.15,2.08,2.74,3.02,2.69,2.04,1.85,1.59,1.73,1.68,1.91,2.49,4.05,4.17,3.26,1.76,1.44,1.56,1.83,2.18)*scotpop/100
